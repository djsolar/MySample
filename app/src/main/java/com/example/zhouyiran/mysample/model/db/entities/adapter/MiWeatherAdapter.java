package com.example.zhouyiran.mysample.model.db.entities.adapter;
...
import com.example.zhouyiran.mysample.model.http.entity.mi.MiAQI;
import com.example.zhouyiran.mysample.model.http.entity.mi.MiForecast;
import com.example.zhouyiran.mysample.model.http.entity.mi.MiIndex;
...
public class MiWeatherAdapter extends WeatherAdapter {
    ...
    public WeatherLive getWeatherLive() {
        return new WeatherLive(miWeather.getRealTime().getCityId(),
                ...
                miWeather.getRealTime().getWindSpeed(), DateConvertUtils.dateToTimeStamp(miWeather.getRealTime().getTime(), DateConvertUtils.DATE_FORMAT_PATTERN_YYYY_MM_DD_HH_MM));
    }
